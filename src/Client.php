...
class Client
{
     ...
     */
    public function __construct($uri = 'mongodb+srv://ozamora:<PVNcPaIVqKsEQCKD>@ingsof-w6zh2.mongodb.net/test?retryWrites=true&w=majority', array $uriOptions = [], array $driverOptions = [])
    {
